#!/usr/bin/env python3
"""
vlfm_source_nav_v12.py - VLFM Light Source Navigation v12
Usage: python3 vlfm_source_nav_v12.py --execute
"""
...
class VLFMSourceNavV12(Node):

    def __init__(self, args):
        super().__init__("vlfm_source_nav_v12")
        self.args   = args
        ...
        while not self.nav_client.wait_for_server(timeout_sec=1.0):
            self.get_logger().info("Nav2 ?? ?...")
        self.get_logger().info("VLFMSourceNavV12 ready.")
...
def main():
    p = argparse.ArgumentParser(description="VLFM ? ??? ?? v12")
    ...
    # ???
    p.add_argument("--debug-dir",  default=os.path.expanduser("~/vlfm_v12_debug"))
