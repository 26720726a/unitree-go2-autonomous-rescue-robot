...
class VLFMSourceNavV20(Node):
    ...
    def pixel_to_world(self, u: int, v: int, pose: Tuple,
                       ...
                       depth_scale: float,
                       tag: str = "DIRECT"
                       ) -> Tuple[Optional[float], Optional[float], Optional[float], str, Optional[float]]:
        ...
        return wx, wy, dist_m, source, world_yaw
    ...
    def _resolve_goal(self, result: Dict, pose: Tuple) -> Optional[Dict]:
        ...
        if mode == "direct":
            ...
            if u is not None and v is not None:
                wx, wy, dist, src, src_yaw = self.pixel_to_world(
                    u, v, pose,
